export const session2 = {
  ...
  quizz: [
    ...
    },
    {
      ...
      assets: {
        img: ["./session/img/q79.jpeg"],
        type: "img",
        question: "./session/fr/audio/q79.mp3",
        explaination: "./session/fr/audio/exp79.mp3",
      },
    },
    {
      id: 80,
      ...
      assets: {
        img: ["./session/img/q80.jpeg"],
        type: "img",
        question: "./session/fr/audio/q80.mp3",
        explaination: "./session/fr/audio/exp80.mp3",
      },
    },
    // {
    //   id: 81,
    ...
    //   assets: {
    //     img: ["./session/img/q81.jpeg"],
    //     type: "img",
       // question: "./session/fr/audio/q81.mp3",
    //     explaination: "./session/fr/audio/exp81.mp3",
    //   },
    // },
  ],
};

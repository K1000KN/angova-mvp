  ...
  questions: [
    {
      ...
      correctAnswer: [1],
      explaination:
        "Où s’arrêter à un stop ? <br/><br/> Lorsque j’arrive à un stop, l'arrêt dans tous les cas est obligatoire à hauteur de la ligne d'effet, placée de manière à ce que je puisse voir correctement l’intersection avant de repartir.",
      assets: {
        img: ["./img/q1.jpeg"],
    ...
    {
      id: 2,
      question: ["Ce panneau annonce la fin :"],
      choices: [
      ...
      correctAnswer: [0],
      explaination:
        "Qu'indique ce panneau ? <br/><br/> La sortie d'une aire piétonne ! Cette zone était réservée à la circulation des piétons. Ils y étaient prioritaires face aux véhicules ayant l'autorisation d'y circuler (desserte locale, livraison, etc). Les règles de circulation générales s'appliquent de nouveau.",
      assets: {
        img: ["./img/q2.jpeg"],
    ...
    {
      id: 3,
      question: ["À 100 km/h, le champ de vision est d'environ :"],
      choices: ["A- 45°", "B- 75°", "C- 90°"],
      correctAnswer: [0],
      explaination:
        "En fonction de quoi le champ de vision varie-t-il ? <br/><br/> L'âge, certaines maladies et la vitesse. À 100 km/h, le champ de vision est d'environ 45°. À 130 km/h, il est d'environ 30°.",
      assets: {
        img: ["./img/q3.jpeg"],
    ...
    },
    {
      ...
      choices: [
        "A- Je freine fort",
        "B- Je freiner progressivement",
        "C- J'allume mes feux de détresse",
      ],
      correctAnswer: [1],
      explaination:
        "Comment agir sans prendre de risque ? <br/><br/> Lorsque je circule, je dois être réactif pour ma sécurité mais ne pas surprendre les autres usagers pour qu’ils aient le temps d’agir également. J’adopte le plus souvent une conduite souple et non brusque ! Ici, la circulation semblait fluide puis elle se ralentit. Je m’adapte et freine en fonction mais pas trop brutalement non plus ! Je n’ai pas à mettre mes feux de détresse puisqu’un usager me suit d’assez près et qu’il va s’adapter lui aussi.",
      assets: {
        img: ["./img/q4.jpeg"],
    ...
    },
    {
      ...
      correctAnswer: [0],
      explaination:
        "Pourquoi l'usager qui me suit fait-il des appels de phares ? <br/><br/> Pour que j'accélère. J'aborde un virage dangereux. Malgré la pression de l'usager derrière moi, je ralentis pour aborder le virage en sécurité.",
      assets: {
        img: ["./img/q5.jpeg"],
    ...
    },
    {
      ...
      correctAnswer: [1],
      explaination:
        "Que signifie PTAC ? <br/><br/> Poids Total Autorisé en Charge. C'est le poids maximal de mon véhicule chargement compris. Si je dépasse le PTAC indiqué sur le certificat d'immatriculation, j'encours une forte amende et l'immobilisation de mon véhicule. De plus, les risques d'accidents sont importants.",
      assets: {
        img: ["./img/q6.jpeg"],
    ...
    {
      id: 7,
      question: ["À 200 mètres, je peux m'arrêter :"],
      choices: [
        "A- pour téléphoner",
        "B- en cas d'urgence",
        "C- pour pique-niquer",
      ...
      correctAnswer: [1],
      explaination:
        "Qu'indique la signalisation ? <br/><br/> Elle signale à 200 m un emplacement d'arrêt d'urgence. Comme son nom l'indique, je ne pourrais m'y arrêter... qu'en cas d'urgence (panne, malaise, etc) ! En aucun cas je n'utilise la bande d'arrêt d'urgence ou un emplacement d'arrêt d'urgence, pour passer un appel 'non-urgent'. Je peux me reposer, pique-niquer ou encore téléphoner sur des aires de repos ou de services. J'en profiterai pour me détendre et prendre un café !",
      assets: {
        img: ["./img/q7.jpeg"],
    ...
    {
      id: 9,
      question: "Je transporte deux enfants à l'arrière de mon véhicule :",
      choices: [
      ...
      correctAnswer: [1],
      explaination:
        "Comment assurer la sécurité de passagers enfants ? <br/>Lorsque les enfants sont bien installés et attachés dans leur siège, à l’arrière de mon véhicule, je m’assure de leur sécurité en enclenchant la sécurité enfant. Je n’ai pas besoin dans ce cas de désactiver l’airbag passager.",
      assets: {
        img: ["./img/q9.jpeg"],
    ...
    },
    {
      ...
      correctAnswer: [1],
      explaination:
        "Qu'est-ce que la distance d'arrêt ? <br/>C'est la distance parcourue entre le moment où je détecte l'obstacle et le moment où mon véhicule s'arrête. La distance d'arrêt comprend donc la distance parcourue pendant le temps de réaction et la distance de freinage.",
      assets: {
        img: ["./img/q10.jpeg"],
    ...
    },
    {
      ...
      correctAnswer: [0],
      explaination:
        "Qu'indique ce panneau ? <br/>La fin de toutes les interdictions précédemment signalées aux véhicules en mouvement. Je reste vigilant et applique les règles de circulation générales (position sur la chaussée, limitation de vitesse, etc).",
      assets: {
        img: ["./img/q11.jpeg"],
    ...
    },
    {
      ...
      correctAnswer: [0],
      explaination:
        "Que fait-il ? <br/>Ce geste est très répandu. C'est un signe de remerciement facile à réaliser pour les motards. Lorsque je facilite le passage à un motard en serrant à droite par exemple. Quand j'ai compris son souhait de me dépasser, celui-ci me remercie d'avoir pris en compte ses difficultés.",
      assets: {
        img: ["./img/q12.jpeg"],
    ...
    },
    {
      ...
      correctAnswer: [0],
      explaination:
        "Que se passe-t-il ? <br/>Le panneau signale que ma voie va être supprimée dans 400 m. Je dois changer de voie. Si je change de voie immédiatement la distance de sécurité avec le véhicule noir sera insuffisante. Je ralentis pour l'augmenter. Je me placerai dans la voie à ma gauche quand la distance de sécurité sera suffisante.",
      assets: {
        img: ["./img/q13.jpeg"],
    ...
    },
    {
      ...
      correctAnswer: [1, 2],
      explaination:
        "Que se passe-t-il ? <br/>J'approche de la sortie du tunnel. Je garde les feux de croisement le temps de la traversée du tunnel. Et je ralentis pour permettre à mes yeux de s'habituer au changement de luminosité.",
      assets: {
        img: ["./img/q14.jpeg"],
    ...
    },
    {
      ...
      correctAnswer: [1],
      explaination:
        "Que se passe-t-il ? <br/>Un engin d'entretien est en action sur la voie de droite. J'adapte mon comportement et l'allure, pour limiter le risque d'accident. Je continue le dépassement en restant dans cette voie. En dépassant l'engin, je serrerai le bord gauche de ma voie, sans chevaucher le zébra central.",
      assets: {
        img: ["./img/q15.jpeg"],
...

    {
      ...
      correctAnswer: [0, 2, 3],
      explaination:
        "Pourquoi est-il important de régler le volant (si mon véhicule le permet) ? <br/>Cela améliore ma position de conduite et ma visibilité. En effet, si le volant se situe trop dans mon champ de vision, il masque en partie ce qui se passe devant moi et les informations du tableau de bord.",
      assets: {
        img: ["./img/q16.jpeg"],
    ...
    },
    {
      ...
      correctAnswer: [0, 3],
      explaination:
        "Qu'est-ce que l'ESP ? <br/>Ce système agit sur la direction du véhicule pour éviter une sortie de trajectoire. Il améliore donc le contrôle de la trajectoire et évite les dérapages.",
      assets: {
        img: ["./img/q17.jpeg"],
    ...
    },
    {
      ...
      correctAnswer: [0],
      explaination:
        "Quels sont les effets de l'alcool sur le cerveau ? <br/>L'alcool altère la compréhension et l'analyse du cerveau. Il met alors plus de temps à traiter l'information. De ce fait, le temps de réaction est augmenté.",
      assets: {
        img: ["./img/q18.jpeg"],
    ...
    {
      id: 19,
      questions: ["Je ralentis :"],
      choices: ["A- OUI", "B- NON"],
      correctAnswer: [0],
      explaination:
        "Pourquoi ralentir ici ? <br/>Je m’apprête à croiser un engin agricole plutôt large, qui utilise toute la chaussée de son côté. Je ne prends pas de risque en ralentissant et en serrant sur ma droite.",
      assets: {
        img: ["./img/q19.jpeg"],
    ...
    },
    {
      ...
      correctAnswer: [0],
      explaination:
        "En fonction de quoi la consommation de carburant varie-t-elle ? <br/>De la vitesse, du poids du véhicule, de son état et de son chargement. Un chargement augmente la consommation. Un coffre de toit ou une galerie l'augmente encore plus (à cause de la résistance à l'air).",
      assets: {
        img: ["./img/q20.jpeg"],
    ...
    },
    {
      ...
      explaination:
        "Qu'est-ce que l'aquaplanage (ou aquaplaning) ? <br/>C'est quand les pneus ne peuvent plus évacuer l'eau qui est sur la route. Les pneus glissent sur une fine couche d'eau. Impossible alors de contrôler le véhicule. Pour éviter ce phénomène, j'utilise des pneus en bon état et adapte l'allure en fonction des conditions météo.",
      assets: {
        img: ["./img/q22.jpeg"],
    ...
    },
    {
      ...
      correctAnswer: [1],
      explaination:
        "Quelles sont les conditions pour dépasser ? La signalisation doit l'autoriser, la visibilité vers l'avant doit être bonne et je ne dois pas gêner les autres usagers. Le marquage autorise le dépassement et ces deux voies sont affectées à mon sens de circulation. Un véhicule me dépasse. Je ne dépasse pas.",
      assets: {
        img: ["./img/q28.jpeg"],

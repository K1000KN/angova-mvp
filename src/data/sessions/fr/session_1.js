export const session1 = {
  ...
  quizz: [
    ...
    },
    {
      ...
      correctAnswer: [1],
      explaination:
        "Comment agir sans prendre de risque ?    Lorsque je circule, je dois être réactif pour ma sécurité mais ne pas surprendre les autres usagers pour qu’ils aient le temps d’agir également. J’adopte le plus souvent une conduite souple et non brusque ! Ici, la circulation semblait fluide puis elle se ralentit. Je m’adapte et freine en fonction mais pas trop brutalement non plus ! Je n’ai pas à mettre mes feux de détresse puisqu’un usager me suit d’assez près et qu’il va s’adapter lui aussi.",
      assets: {
        img: ["../session/img/q4.mp4"],
        type: "video",
        question: "../session/audio/fr/q4.mp3",
        explaination: "../session/audio/fr/exp4.mp3",
      },
    },
    {
      id: 5,
    ...
    },
    {
      ...
      correctAnswer: [0],
      explaination:
        "Pourquoi ralentir ici ?  Je m’apprête à croiser un engin agricole plutôt large, qui utilise toute la chaussée de son côté. Je ne prends pas de risque en ralentissant et en serrant sur ma droite.",
      assets: {
        img: ["../session/img/q19.mp4"],
        type: "video",
        question: "../session/audio/fr/q19.mp3",
        explaination: "../session/audio/fr/exp19.mp3",
      },
    },
    {
      id: 20,
    ...
    },
    {
      ...
      assets: {
        img: ["../session/img/q28.mp4"],
        type: "video",
        question: "../session/audio/fr/q28.mp3",
        explaination: "../session/audio/fr/exp28.mp3",
      },
    },
    {
      id: 29,

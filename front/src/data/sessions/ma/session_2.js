  ...
  quizz: [
    {
      ...
      choices: [
        " une autoroute",
        " une route à accès réglementé",
        " des automobilistes uniquement",
        " des véhicules pouvant circuler à allure soutenue (rapidement)",
      ],
      correctAnswer: [1, 3],
      explaination: `Qu'indiquent ces panneaux ? Celui du haut signale une route à accès réglementé. L'autre signale une fin d'autoroute.
        Sur ces deux types de routes, seuls les voitures, les camions ou encore les motos peuvent circuler.`,
      assets: {
        img: ["../session/q41/q41.jpeg"],

        question: "../session/q41/ma/q41.mp3",
        explaination: "../session/q41/ma/exp41.mp3",
      },
    },
    {
      id: 42,
      ...
      assets: {
        ...
        question: "../session/q42/ma/q42.mp3",
        explaination: "../session/q42/ma/exp42.mp3",
      },
    },
    {
      id: 43,
      ...
      choices: [" dans les égouts", " ou à la déchetterie"],
      correctAnswer: [1],
      explaination:
      ...
      assets: {
        ...
        question: "../session/q43/ma/q43.mp3",
        explaination: "../session/q43/ma/exp43.mp3",
      },
    },
    {
      id: 44,
      ...
      correctAnswer: [1, 2],
      explaination:
        "Quels sont les risques avec un animal ? Même si vous pensez bien le connaître, un animal peut avoir des réactions imprévisibles lorsqu’il se trouve dans un véhicule, vous empêchant alors de rester concentré sur votre conduite. Il peut également être blessé en cas de maeinage brutal. Pour éviter tout risque, les animaux doivent être installés dans le cofmae ou à l’arrière avec une ceinture adaptée.",
      assets: {
        img: ["../session/q44/q44.jpeg"],

        question: "../session/q44/ma/q44.mp3",
        explaination: "../session/q44/ma/exp44.mp3",
      },
    },
    {
      id: 45,
      ...
      assets: {
        ...
        question: "../session/q45/ma/q45.mp3",
        explaination: "../session/q45/ma/exp45.mp3",
      },
    },
    {
      id: 46,
      ...
      assets: {
        ...
        question: "../session/q46/ma/q46.mp3",
        explaination: "../session/q46/ma/exp46.mp3",
      },
    },
    {
      id: 47,
      ...
      assets: {
        ...
        question: "../session/q47/ma/q47.mp3",
        explaination: "../session/q47/ma/exp47.mp3",
      },
    },
    {
      id: 48,
      questions: ["Dans cette situation:"],
      choices: [" - Je passe le feu", " Je m'arrête au feu"],
      correctAnswer: [1],
      explaination:
      ...
      assets: {
        ...
        question: "../session/q48/ma/q48.mp3",
        explaination: "../session/q48/ma/exp48.mp3",
      },
    },
    {
      id: 49,
      ...
      assets: {
        ...
        question: "../session/q49/ma/q49.mp3",
        explaination: "../session/q49/ma/exp49.mp3",
      },
    },
    {
      id: 50,
      ...
      assets: {
        ...
        question: "../session/q50/ma/q50.mp3",
        explaination: "../session/q50/ma/exp50.mp3",
      },
    },
    {
      id: 51,
      ...
      choices: [
        " de nuit en ville éclairée",
        " dans un tunnel éclairé en agglomération",
        " pour être vu",
        " pour mieux voir",
      ],
      correctAnswer: [0, 1, 2],
      ...
      assets: {
        ...
        question: "../session/q51/ma/q51.mp3",
        explaination: "../session/q51/ma/exp51.mp3",
      },
    },
    {
      id: 52,
      ...
      assets: {
        ...
        question: "../session/q52/ma/q52.mp3",
        explaination: "../session/q52/ma/exp52.mp3",
      },
    },
    {
      id: 53,
      ...
      choices: [
        " un élément non dangereux",
        " une anomalie de fonctionnement",
        " de la température élevé du liquide de remaoidissement",
        " d'une baisse du niveau de l'huile moteur",
      ],
      correctAnswer: [1, 2],
      explaination:
        "Qu'indiquent les voyants rouges ? Ils signalent une anomalie de fonctionnement. Si en circulant, l'un d'eux s'allume, je m'arrête dès que possible en sécurité. Les éléments non dangereux sont signalés par des voyants orange. Le voyant n°3 signale une surchauffe du liquide de remaoidissement.",
      assets: {
        img: ["../session/q53/q53.jpeg"],

        question: "../session/q53/ma/q53.mp3",
        explaination: "../session/q53/ma/exp53.mp3",
      },
    },

    {
      ...
      assets: {
        ...
        question: "../session/q54/ma/q54.mp3",
        explaination: "../session/q54/ma/exp54.mp3",
      },
    },
    {
      id: 55,
      ...
      assets: {
        ...
        question: "../session/q55/ma/q55.mp3",
        explaination: "../session/q55/ma/exp55.mp3",
      },
    },
    {
      id: 56,
      ...
      choices: [" Oui", " Non", " 1 seconde", " 2 secondes"],
      correctAnswer: [0, 2],
      explaination:
      ...
      assets: {
        ...
        question: "../session/q56/ma/q56.mp3",
        explaination: "../session/q56/ma/exp56.mp3",
      },
    },
    {
      id: 57,
      ...
      choices: [
        ...
        " est dangereuse pour la victime",
      ...
      assets: {
        ...
        question: "../session/q57/ma/q57.mp3",
        explaination: "../session/q57/ma/exp57.mp3",
      },
    },
    {
      id: 58,
      ...
      assets: {
        ...
        question: "../session/q58/ma/q58.mp3",
        explaination: "../session/q58/ma/exp58.mp3",
      },
    },
    {
      id: 59,
      ...
      assets: {
        ...
        question: "../session/q59/ma/q59.mp3",
        explaination: "../session/q59/ma/exp59.mp3",
      },
    },
    {
      id: 60,
    ...
    },
    {
      ...
      assets: {
        ...
        question: "../session/q61/ma/q61.mp3",
        explaination: "../session/q61/ma/exp61.mp3",
      },
    },
    {
      id: 62,
      ...
      assets: {
        ...
        question: "../session/q62/ma/q62.mp3",
        explaination: "../session/q62/ma/exp62.mp3",
      },
    },
    {
      id: 63,
      questions: ["Dans cette situation :"],
      choices: [" Je maintiens l'allure", " J'accélère", " Je m'arrête"],
      correctAnswer: [2],
      explaination:
      ...
      assets: {
        ...
        question: "../session/q63/ma/q63.mp3",
        explaination: "../session/q63/ma/exp63.mp3",
      },
    },
    {
      id: 64,
      ...
      assets: {
        ...
        question: "../session/q64/ma/q64.mp3",
        explaination: "../session/q64/ma/exp64.mp3",
      },
    },
    {
      id: 65,
      questions: ["À 50 km/h, je parcours en 1 seconde environ :"],
      choices: [" 15 mètres", " 5 mètres"],
      correctAnswer: [0],
      explaination:
        "Comment connaître la distance parcourue en une seconde ? En multipliant par 3 le chifmae des dizaines de la vitesse. À 50 km/h, je parcours (5x3) 15 m.",
      assets: {
        img: ["../session/q65/q65.jpeg"],

        question: "../session/q65/ma/q65.mp3",
        explaination: "../session/q65/ma/exp65.mp3",
      },
    },
    {
      id: 66,
      questions: [
        ...
        "- Je mets le pied devant le maein :",
      ],
      choices: [" de droite", " de gauche", " Oui", " Non"],
      correctAnswer: [0, 1, 2],
      explaination:
        "Quels sont les risques ?\nJ'aborde une intersection où la visibilité est masquée. Un usager peut arriver. La camionnette à droite masque la visibilité à droite. Un piéton peut traverser devant elle ou un autre usager peut sortir du parking. Je mets le pied devant le maein, hiérarchise les dangers pour les traiter correctement et éviter un accident.",
      assets: {
        img: ["../session/q66/q66.jpeg"],

        question: "../session/q66/ma/q66.mp3",
        explaination: "../session/q66/ma/exp66.mp3",
      },
    },
    {
      id: 67,
      ...
      choices: [
        ...
        " diminue la pollution et le bruit",
      ...
      assets: {
        ...
        question: "../session/q67/ma/q67.mp3",
        explaination: "../session/q67/ma/exp67.mp3",
      },
    },
    {
      id: 68,
      ...
      assets: {
        ...
        question: "../session/q68/ma/q68.mp3",
        explaination: "../session/q68/ma/exp68.mp3",
      },
    },
    {
      id: 69,
      ...
      assets: {
        ...
        question: "../session/q69/ma/q69.mp3",
        explaination: "../session/q69/ma/exp69.mp3",
      },
    },
    {
      id: 70,
      ...
      assets: {
        ...
        question: "../session/q70/ma/q70.mp3",
        explaination: "../session/q70/ma/exp70.mp3",
      },
    },
    {
      id: 71,
      ...
      correctAnswer: [1, 2, 3],
      explaination:
        "Quels sont les risques ? La rue est étroite, à double sens de circulation et est bordée d'habitations et de trottoirs étroits. Le risque d'accident est important. Je ralentis et serre à droite. Lorsque je serai à côté du camion, je garderai le pied devant le maein pour m'arrêter si nécessaire.",
      assets: {
        img: ["../session/q71/q71.jpeg"],

        question: "../session/q71/ma/q71.mp3",
        explaination: "../session/q71/ma/exp71.mp3",
      },
    },
    {
      id: 72,
      ...
      assets: {
        ...
        question: "../session/q72/ma/q72.mp3",
        explaination: "../session/q72/ma/exp72.mp3",
      },
    },
    {
      id: 73,
      ...
      assets: {
        ...
        question: "../session/q73/ma/q73.mp3",
        explaination: "../session/q73/ma/exp73.mp3",
      },
    },
    {
      id: 74,
      ...
      assets: {
        ...
        question: "../session/q74/ma/q74.mp3",
        explaination: "../session/q74/ma/exp74.mp3",
      },
    },
    {
      id: 75,
      ...
      assets: {
        ...
        question: "../session/q75/ma/q75.mp3",
        explaination: "../session/q75/ma/exp75.mp3",
      },
    },
    {
      id: 76,
      ...
      choices: [
        " Je continue dans ma voie",
        " Je m'arrête immédiatement",
        " J'allume le clignotant droit",
      ],
      correctAnswer: [0],
      explaination:
      ...
      assets: {
        ...
        question: "../session/q76/ma/q76.mp3",
        explaination: "../session/q76/ma/exp76.mp3",
      },
    },
    {
      id: 77,
      questions: ["Dans cette situation:"],
      choices: [
        " Je maintiens la trajectoire",
        " ou je serre à gauche de ma voie",
      ],
      correctAnswer: [1],
      explaination:
      ...
      assets: {
        ...
        question: "../session/q77/ma/q77.mp3",
        explaination: "../session/q77/ma/exp77.mp3",
      },
    },
    {
      id: 78,
      ...
      assets: {
        ...
        question: "../session/q78/ma/q78.mp3",
        explaination: "../session/q78/ma/exp78.mp3",
      },
    },
    {
      id: 79,
      questions: ["Je stationne de préférence :"],
      choices: [
        " à gauche",
        " à droite",
        " en marche avant",
      ...
      correctAnswer: [1, 3],
      explaination:
        "Quels sont les risques en stationnant ? De gêner les usagers qui me suivent et en face. Pour limiter la gêne et donc le risque d'accident, il est conseillé de stationner de préférence à droite en bataille. Je stationne en marche arrière, pour voir le mieux possible au moment de repartir.",
      assets: {
        img: ["../session/q79/q79.jpeg"],

        question: "../session/q79/ma/q79.mp3",
        explaination: "../session/q79/ma/exp79.mp3",
      },
    },
    {
      id: 80,
      questions: [
        " ",
        "Le véhicule est en action. Je dépasse :",
        "La circulation devant ce véhicule est sécurisée :",
      ],
      choices: [" Oui", " Non", " Oui", " Non"],
      correctAnswer: [1, 3],
      explaination:
        "Quel est le rôle des véhicules de déneigement ? Ils sécurisent la circulation lorsque la chaussée est impraticable. Je reste derrière ce véhicule en respectant la distance de sécurité.",
      assets: {
        img: ["../session/q80/q80_1.jpeg", "../session/q80/q80_2.jpeg"],

        question: "../session/q80/ma/q80.mp3",
        explaination: "../session/q80/ma/exp80.mp3",
      },
    },
  ],
};
